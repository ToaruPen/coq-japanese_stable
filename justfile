...
player_log := env_var("HOME") + "/Library/Logs/Freehold Games/CavesOfQud/Player.log"
...
issue737-runtime-closeout min_mtime="2026-05-19T20:33:00+09:00" log=player_log output="/tmp/issue737-runtime-closeout.json":
  {{python}} scripts/issue737_runtime_closeout.py --log {{quote(log)}} --min-mtime {{quote(min_mtime)}} --output {{quote(output)}}
...
issue737-runtime-closeout-strict min_mtime="2026-05-19T20:33:00+09:00" log=player_log output="/tmp/issue737-runtime-closeout.json":
  {{python}} scripts/issue737_runtime_closeout.py --log {{quote(log)}} --min-mtime {{quote(min_mtime)}} --output {{quote(output)}} --require-passed
