...
localization-check:
  ...
  {{python}} scripts/validate_pattern_routes.py Mods/QudJP/Localization/Dictionaries/messages.ja.json --require-needs-harmony-patch-deferrals --expect-count message-frame=53 --expect-count popup=24 --expect-count journal=1 --expect-count leaf=0 --expect-count emit-message=384 --expect-count does-verb=0 --expect-count message-log=1 --expect-count description=14 --expect-count effect-cripple=1 --expect-count needs-harmony-patch=0 --expect-count unclassified=0
