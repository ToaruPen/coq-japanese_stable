...
public sealed class PickItemTakeAllPopupTranslationPatchTests
{
    ...
    [Test]
    public void TakeAll_HitCountIsZero_WhenEmptyPopupEncountered_WhenOwnerPatched()
    {
        AssertPopupMessage(string.Empty, string.Empty);

        Assert.That(TakeAllHitCount(), Is.Zero);
    }

    [Test]
    public void TakeAll_HitCountIsZero_WhenUnknownPopupEncountered_WhenOwnerPatched()
    {
        const string source = "Taking {{unknown|this object}} will put you over your weight limit. Are you sure you want to do it?";
    ...
    [Test]
    public void TakeAll_DoesNotTranslateAllObjects_WhenOwnerAbsent_WithAllObjectsMessage()
    {
        const string source = "Taking all these objects will put you over your weight limit. Are you sure you want to do it?";
        var harmonyId = CreateHarmonyId();
        var harmony = new Harmony(harmonyId);
        try
        {
