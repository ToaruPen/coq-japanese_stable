...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DynamicQuestGeneratedQuestTextTranslator.cs:132:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated quest/step captures use MarkupAwareRestoreCapture.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3327:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3361:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:4133:TryLoadLocalizedBlueprintDisplayNameMarkup"] = "Audited Strip call: blueprint display-name markup is stripped only to build a visible-name lookup key; restored markup comes from the same DisplayName attribute.",
