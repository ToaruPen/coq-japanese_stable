...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1385:IsAlreadyLocalizedPopupText"] = "Predicate only; it compares stripped and original text.",
            ...
            ["Mods/QudJP/Assemblies/src/Translation/JournalPatternTranslator.cs:75:Translate"] = "Passes stripped text and spans to TranslateStripped, where template application restores colors.",
            ["Mods/QudJP/Assemblies/src/Translation/MessagePatternTranslator.cs:78:Translate"] = "Passes stripped text and spans to TranslateStripped, where template application restores colors.",
