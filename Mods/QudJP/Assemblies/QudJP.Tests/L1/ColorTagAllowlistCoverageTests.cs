...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingMealDescriptionTranslator.cs:40:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after ingredient captures use MarkupAwareRestoreCapture.",
