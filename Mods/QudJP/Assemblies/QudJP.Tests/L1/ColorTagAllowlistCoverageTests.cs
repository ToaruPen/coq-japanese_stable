...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:155:TryFindDanglingBoundaryOpening"] = "Uses stripped spans only to detect carried color boundary tokens for synthetic line reconstruction.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:211:HasColorBoundaryOpening"] = "Predicate only; it uses stripped spans to detect color boundary tokens.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:246:HasColorBoundaryClosing"] = "Predicate only; it uses stripped spans to detect color boundary closure.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:317:TryTranslateSultanShrineWrapperPreservingColors"] = "Passes stripped text and spans to SultanShrineWrapperTranslator.",
