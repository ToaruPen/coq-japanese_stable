...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1443:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1808:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
