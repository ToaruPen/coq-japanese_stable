...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CampfirePreserveTranslationPatch.cs:191:TranslatePreservedLine"] = "Audited Strip call: preserve source, serving, and result captures are restored through the local Restore helper before owner-route translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/FriendOrFoeReasonTranslator.cs:67:TryTranslate"] = "Audited Strip call: whole-source boundary wrappers are restored through RestoreWhole for every translated friend-or-foe reason frame.",
