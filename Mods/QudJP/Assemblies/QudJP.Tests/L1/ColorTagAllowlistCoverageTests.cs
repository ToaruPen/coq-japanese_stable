...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingEffectFragmentTranslator.cs:432:TryTranslate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:244:TryTranslateSplitHistoryHeaderStartLine"] = "Audited Strip call: split history header colors are restored by preserving source boundary tokens across the following line.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:448:TryTranslateSplitHistoryHeaderContinuationLine"] = "Audited Strip call: split history continuation is predicate-only before appending the localized suffix after the source color boundary.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:539:TryFindDanglingBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:595:HasColorBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:630:HasColorBoundaryClosing"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:752:TryTranslateSultanShrineWrapperPreservingColors"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:860:TryTranslateRegainsChargeWhenWornOrHeldLine"] = "Audited Strip call: whole-line color wrappers are restored through RestoreWholeLineBoundaryWrappers after the fixed description template is reconstructed.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:2338:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:2372:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/LiquidVolumeFragmentTranslator.cs:250:TryTranslate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/MessageLogPatch.cs:76:Prefix"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslatedMessageHandoff.cs:249:CreateKey"] = "Audited Strip call: handoff key captures visible text and color shape only; it does not modify display ownership.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1594:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1750:ContainsVisibleAsciiLetters"] = "Audited Strip call: predicate-only ASCII check over visible recipe text; color ownership is restored before the predicate result is emitted.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:2167:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:277:TranslatePopupTextForRoute"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:393:TryTranslatePopupProducerText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/SingleCallsiteOwnerPopupTranslationPatch.cs:1763:TryTranslatePhysicsAttackConfirm"] = "Audited Strip call: attack-confirm target colors are restored by PopupTranslationPatch.TryTranslatePhysicsAttackConfirmText.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:1076:ShouldSkipMessagePatternTranslation"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:326:TryTranslatePerformOfferTradeWaterMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:344:TryTranslateHasNothingToTradeMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:362:TryTranslateTradeUiPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:570:TryTranslateMasterworkTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:604:TryTranslateBeamsplitterTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:643:TryTranslateOffhandAttackChanceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:682:TryTranslateStrengthBonusCapTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only the cap capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:717:TryTranslateWeaponClassTemplate"] = "Audited Strip call: whole-source rules wrappers are restored after translating only the weapon class capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:773:TryTranslateCoProcessorTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:866:TryTranslateActiveLightSourceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:937:TryTranslateCounterweightedTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1117:TryTranslateDisguiseReputationTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1167:TryTranslateElementalDamageTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1201:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
