...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DisassemblyStartTranslationPatch.cs:159:TryTranslateReverseEngineerPrompt"] = "Audited Strip call: color ownership is restored through MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/DisassemblyStartTranslationPatch.cs:179:TryTranslateStartDisassemblingMessage"] = "Audited Strip call: color ownership is restored through MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/DisassemblyStartTranslationPatch.cs:199:TryTranslateDisassembleReceiptMessage"] = "Audited Strip call: disassembled item, build target, mod target, and bit captures are restored before owner-route translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GameObjectPopupTranslationPatch.cs:127:TryTranslatePopupMessage"] = "Audited Strip call: companion ability and follow-distance menu captures are restored through MarkupAwareRestoreCapture, and whole-row wrappers are restored after option/state translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:2989:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3023:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3703:TryLoadLocalizedBlueprintDisplayNameMarkup"] = "Audited Strip call: blueprint display-name markup is stripped only to build a visible-name lookup key; restored markup comes from the same DisplayName attribute.",
            ["Mods/QudJP/Assemblies/src/Patches/HiddenRenderTranslationPatch.cs:125:TryTranslateRevealMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1784:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1940:ContainsVisibleAsciiLetters"] = "Audited Strip call: predicate-only ASCII check over visible recipe text; color ownership is restored before the predicate result is emitted.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:2357:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:295:TranslatePopupTextForRoute"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:411:TryTranslatePopupProducerText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/RandomAltarBaetylTranslationPatch.cs:91:TryTranslatePopupMessage"] = "Audited Strip call: baetyl demand/reward captures restore item, reward, offering, and baetyl colors through MarkupAwareRestoreCapture.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:665:TryTranslateHeartstopperTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only template captures.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:700:TryTranslateSmartTrackingScopeTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only template captures.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:730:TryTranslateMasterworkTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:764:TryTranslateBeamsplitterTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:803:TryTranslateOffhandAttackChanceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:842:TryTranslateStrengthBonusCapTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only the cap capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:877:TryTranslateWeaponClassTemplate"] = "Audited Strip call: whole-source rules wrappers are restored after translating only the weapon class capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:933:TryTranslateCoProcessorTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1026:TryTranslateActiveLightSourceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1097:TryTranslateCounterweightedTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1277:TryTranslateDisguiseReputationTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1327:TryTranslateElementalDamageTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1361:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
