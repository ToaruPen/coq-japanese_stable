...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/SifrahPureOwnerPopupTranslationPatch.cs:285:TryTranslatePopupMessage"] = "Delegates dynamic target and whole-source wrapper restoration to matched owner-route helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/SifrahPureOwnerPopupTranslationPatch.cs:495:TryGetPureOwnerBatchPopupCandidateText"] = "Predicate only; strips direct-marker text and color markup to classify owner-only popup candidates.",
