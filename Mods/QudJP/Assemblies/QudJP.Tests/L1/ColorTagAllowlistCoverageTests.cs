...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/EmboldenedTranslationPatch.cs:121:TryTranslateCore"] = "Delegates stat capture restoration and whole-source wrapper restoration to matched branches.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/QuestLifecyclePopupTranslationPatch.cs:104:TryTranslatePopupMessage"] = "Delegates quest item captures and whole-source wrapper restoration to matched owner-route helpers.",
