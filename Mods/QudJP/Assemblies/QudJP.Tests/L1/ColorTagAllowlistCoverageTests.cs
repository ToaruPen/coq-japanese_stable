...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CampfirePreserveTranslationPatch.cs:188:TranslatePreservedLine"] = "Audited Strip call: preserve source, serving, and result captures are restored through the local Restore helper before owner-route translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/ImportedFoodOrDrinkFactionNameTranslator.cs:28:TryTranslate"] = "Audited Strip call: whole-source boundary wrappers are restored through RestoreWhole for translated generated faction-name frames.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/FriendOrFoeReasonTranslator.cs:54:TryTranslate"] = "Audited Strip call: whole-source boundary wrappers are restored through RestoreWhole for every translated friend-or-foe reason frame.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1529:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1894:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
