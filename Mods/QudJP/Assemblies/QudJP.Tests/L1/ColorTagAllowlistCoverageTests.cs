...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:173:TryTranslateSplitHistoryHeaderStartLine"] = "Audited Strip call: split history header colors are restored by preserving source boundary tokens across the following line.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:368:TryTranslateSplitHistoryHeaderContinuationLine"] = "Audited Strip call: split history continuation is predicate-only before appending the localized suffix after the source color boundary.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:458:TryFindDanglingBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:514:HasColorBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:549:HasColorBoundaryClosing"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:654:TryTranslateSultanShrineWrapperPreservingColors"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:241:TranslatePreservingColors"] = "Audited Strip call: display-name route colors are restored by route-specific suffix/fragment branches or preserved by source-markup-aware helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:1787:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:1821:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1444:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1809:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:321:TranslatePopupMenuItemTextForRoute"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:412:TryTranslatePopupProducerText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:552:TryTranslateMasterworkTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:586:TryTranslateBeamsplitterTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:625:TryTranslateOffhandAttackChanceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:664:TryTranslateCoProcessorTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:749:TryTranslateActiveLightSourceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:820:TryTranslateCounterweightedTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1000:TryTranslateDisguiseReputationTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1050:TryTranslateElementalDamageTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1083:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
