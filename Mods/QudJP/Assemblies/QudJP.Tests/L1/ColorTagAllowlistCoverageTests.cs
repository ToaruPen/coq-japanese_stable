...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingMealDescriptionTranslator.cs:34:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after ingredient captures use MarkupAwareRestoreCapture.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DynamicQuestConversationTextTranslator.cs:68:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated quest conversation captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/DynamicQuestExplicitConversationTextTranslator.cs:64:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after explicit dynamic quest conversation captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/DynamicQuestGeneratedQuestTextTranslator.cs:98:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated quest/step captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/EaterCryptPlaqueTextTranslator.cs:90:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after finite crypt plaque fragment translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PhysicsProcessTakeDamageTranslationPatch.cs:140:TryTranslateDamageFrame"] = "Audited Strip call: damage-frame source and damage-type captures are restored through local MarkupAwareRestoreCapture helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1608:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TempleDedicationPlaqueInscriptionTranslator.cs:28:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after finite temple dedication frame translation.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/VillageLeaderConversationTranslator.cs:40:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated village leader conversation captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/VillagePetConversationTranslator.cs:86:TryTranslateQuestion"] = "Audited Strip call: whole-source wrappers are restored after generated village pet question captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/VillagePetConversationTranslator.cs:116:TryTranslateAnswer"] = "Audited Strip call: whole-source wrappers are restored after generated village pet origin-story captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/VillageWallDescriptionTranslator.cs:67:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated wall/canvas captures use MarkupAwareRestoreCapture.",
            ["Mods/QudJP/Assemblies/src/Patches/VillageWallDescriptionTranslator.cs:147:ContainsLowercaseAsciiWord"] = "Audited Strip call: predicate-only guard used to reject untranslated lowercase capture residue after candidate translation.",
            ["Mods/QudJP/Assemblies/src/Patches/VillageTerrainRevealDescriptionTranslator.cs:166:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated village terrain captures use MarkupAwareRestoreCapture.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:543:TryTranslateCoProcessorTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:628:TryTranslateActiveLightSourceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:699:TryTranslateCounterweightedTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:728:TryTranslateDisguiseReputationTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:775:TryTranslateElementalDamageTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:808:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
