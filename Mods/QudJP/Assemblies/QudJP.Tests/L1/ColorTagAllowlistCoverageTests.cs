...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3127:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3161:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3927:TryLoadLocalizedBlueprintDisplayNameMarkup"] = "Audited Strip call: blueprint display-name markup is stripped only to build a visible-name lookup key; restored markup comes from the same DisplayName attribute.",
