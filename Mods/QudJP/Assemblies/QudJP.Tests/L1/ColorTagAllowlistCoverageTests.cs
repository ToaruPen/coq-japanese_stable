...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/ActiveEffectTextTranslator.cs:160:TryTranslateExact"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/ActiveEffectTextTranslator.cs:199:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/BasePronounProviderCustomizePopupTranslationPatch.cs:114:TryTranslateCustomizePopup"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingEffectFragmentTranslator.cs:462:TryTranslate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingRuntimeTranslationPatch.cs:331:TryTranslateWellFedPopup"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:274:TryTranslateSplitHistoryHeaderStartLine"] = "Audited Strip call: split history header colors are restored by preserving source boundary tokens across the following line.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:478:TryTranslateSplitHistoryHeaderContinuationLine"] = "Audited Strip call: split history continuation is predicate-only before appending the localized suffix after the source color boundary.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:569:TryFindDanglingBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:625:HasColorBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:660:HasColorBoundaryClosing"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:787:TryTranslateSultanShrineWrapperPreservingColors"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:895:TryTranslateRegainsChargeWhenWornOrHeldLine"] = "Audited Strip call: whole-line color wrappers are restored through RestoreWholeLineBoundaryWrappers after the fixed description template is reconstructed.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DynamicQuestGeneratedQuestTextTranslator.cs:133:TryTranslate"] = "Audited Strip call: whole-source wrappers are restored after generated quest/step captures use MarkupAwareRestoreCapture.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/FactionsStatusScreenTranslationPatch.cs:940:AddLocalizedSearchFragment"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GeneratedQueueDoesVerbTranslationPatch.cs:157:TryTranslateQueuedMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3294:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:3328:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:4106:TryLoadLocalizedBlueprintDisplayNameMarkup"] = "Audited Strip call: blueprint display-name markup is stripped only to build a visible-name lookup key; restored markup comes from the same DisplayName attribute.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PhysicsProcessTakeDamageTranslationPatch.cs:261:TryTranslateDamageFrame"] = "Audited Strip call: damage-frame source and damage-type captures are restored through local MarkupAwareRestoreCapture helpers.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:2066:TranslateCookingRecipeNameForInventoryActionMenu"] = "Audited Strip call: recipe-name colors are restored through CookbookDisplayNameTranslator after inventory action menu parsing.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:2222:ContainsVisibleAsciiLetters"] = "Audited Strip call: predicate-only ASCII check over visible recipe text; color ownership is restored before the predicate result is emitted.",
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:2795:IsAlreadyLocalizedPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:458:TryTranslatePopupProducerText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/QuestLifecyclePopupTranslationPatch.cs:119:TryTranslatePopupMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/SingleCallsiteOwnerPopupTranslationPatch.cs:1963:TryTranslatePhysicsAttackConfirm"] = "Audited Strip call: attack-confirm target colors are restored by PopupTranslationPatch.TryTranslatePhysicsAttackConfirmText.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:1119:ShouldSkipMessagePatternTranslation"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:345:TryTranslatePerformOfferTradeWaterMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:363:TryTranslateHasNothingToTradeMessage"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:381:TryTranslateTradeUiPopupText"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:767:TryTranslateHeartstopperTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only template captures.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:802:TryTranslateSmartTrackingScopeTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only template captures.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:832:TryTranslateMasterworkTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:866:TryTranslateBeamsplitterTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:918:TryTranslateMeleeAttackChanceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:972:TryTranslateStrengthBonusCapTemplate"] = "Audited Strip call: color ownership is restored through TryFormatTemplate after translating only the cap capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1007:TryTranslateWeaponClassTemplate"] = "Audited Strip call: whole-source rules wrappers are restored after translating only the weapon class capture.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1063:TryTranslateCoProcessorTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1156:TryTranslateActiveLightSourceTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1227:TryTranslateCounterweightedTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1407:TryTranslateDisguiseReputationTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1457:TryTranslateElementalDamageTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/WorldModsTextTranslator.cs:1491:TryTranslateTemplate"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ...
            ["Mods/QudJP/Assemblies/src/Translation/MessagePatternTranslator.cs:135:TranslateCore"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
    ...
    private static readonly string[] DisplayNameOwnerRouteFiles =
    {
        ...
        "Mods/QudJP/Assemblies/src/Patches/InventoryActionMenuShowTimingPatch.cs",
