...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:180:TryTranslateSplitHistoryHeaderStartLine"] = "Audited Strip call: split history header colors are restored by preserving source boundary tokens across the following line.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:375:TryTranslateSplitHistoryHeaderContinuationLine"] = "Audited Strip call: split history continuation is predicate-only before appending the localized suffix after the source color boundary.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:466:TryFindDanglingBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:522:HasColorBoundaryOpening"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:557:HasColorBoundaryClosing"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:669:TryTranslateSultanShrineWrapperPreservingColors"] = "Audited Strip call: color ownership is restored in a downstream branch/helper or the call is predicate/observation-only.",
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionTextTranslator.cs:737:TryTranslateRegainsChargeWhenWornOrHeldLine"] = "Audited Strip call: whole-line color wrappers are restored through RestoreWholeLineBoundaryWrappers after the fixed description template is reconstructed.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:1860:TranslateDisplayNameWithClause"] = "Audited Strip call: with-clause colors are restored by source-markup-aware clause helpers after dictionary lookup.",
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameRouteTranslator.cs:1894:TranslateDisplayNameWithClausePreservingSourceMarkup"] = "Audited Strip call: source-owned with-clause markup is restored through component-aware clause helpers after dictionary lookup.",
