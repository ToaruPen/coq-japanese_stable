...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/BeguilingSifrahTranslationPatch.cs:105:TryTranslatePopupMessage"] = "Delegates dynamic target and whole-source wrapper restoration to matched owner-route helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/CampfirePreserveTranslationPatch.cs:139:TranslatePreservedLine"] = "Preserve result lines strip once, then restore each captured food/result fragment.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CombatTextSurfaceTranslationPatch.cs:143:TryTranslateQueuedMessage"] = "Uses stripped text only for owner-route detection; queued message text is replaced wholesale.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CookingRuntimeTranslationPatch.cs:214:TryTranslateWellFedPopup"] = "Well-fed popup body delegates each effect line to cooking effect fragment restoration.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/EmboldenedTranslationPatch.cs:118:TryTranslateCore"] = "Delegates stat capture restoration and whole-source wrapper restoration to matched branches.",
            ["Mods/QudJP/Assemblies/src/Patches/EnclosingFragmentTranslator.cs:68:TryTranslatePopupMessage"] = "Delegates capture restoration to RestoreVisible.",
            ["Mods/QudJP/Assemblies/src/Patches/EnclosingFragmentTranslator.cs:143:TryTranslateQueuedMessage"] = "Delegates capture restoration to RestoreVisible.",
            ["Mods/QudJP/Assemblies/src/Patches/ExaminerTranslationPatch.cs:104:TryTranslatePopupMessage"] = "Delegates dynamic target and whole-source wrapper restoration to matched owner-route helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/FactionsLineTranslationPatch.cs:70:TranslateTextField"] = "Strips only to detect whether the already-localized field contains visible text.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:1583:IsAlreadyLocalizedPopupText"] = "Predicate only; it compares stripped and original text.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupTranslationPatch.cs:409:TryTranslatePopupProducerText"] = "Delegates capture restoration to template/exact branch helpers.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/RebukingSifrahTranslationPatch.cs:96:TryTranslatePopupMessage"] = "Delegates dynamic target and whole-source wrapper restoration to matched owner-route helpers.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/SifrahPureOwnerPopupTranslationPatch.cs:293:TryTranslatePopupMessage"] = "Delegates dynamic target and whole-source wrapper restoration to matched owner-route helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/SifrahPureOwnerPopupTranslationPatch.cs:503:TryGetPureOwnerBatchPopupCandidateText"] = "Predicate only; strips direct-marker text and color markup to classify owner-only popup candidates.",
            ["Mods/QudJP/Assemblies/src/Patches/SifrahTokenItemPopupTranslationPatch.cs:134:TryTranslatePopupMessage"] = "Delegates dynamic item captures and whole-source wrapper restoration to matched owner-route helpers.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:309:TryTranslatePerformOfferTradeWaterMessage"] = "Popup sink handoff delegates capture restoration to the PerformOffer owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:327:TryTranslateHasNothingToTradeMessage"] = "Popup sink handoff delegates capture restoration to the has-nothing owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:345:TryTranslateTradeUiPopupText"] = "Delegates capture restoration to branch-specific RestoreCapture helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:1020:ShouldSkipMessagePatternTranslation"] = "Predicate only; it strips markup to classify already-localized visible popup text.",
            ["Mods/QudJP/Assemblies/src/Patches/TutorialManagerTranslationPatch.cs:56:TryTranslateExpandedHotkeyText"] = "Expanded tutorial hotkey markup is stripped to use the visible key and intentionally not restored into translated prose.",
