...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/EnclosingFragmentTranslator.cs:53:TryTranslatePopupMessage"] = "Delegates capture restoration to RestoreVisible.",
            ["Mods/QudJP/Assemblies/src/Patches/EnclosingFragmentTranslator.cs:116:TryTranslateQueuedMessage"] = "Delegates capture restoration to RestoreVisible.",
            ...
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:300:TryTranslatePerformOfferTradeWaterMessage"] = "Popup sink handoff delegates capture restoration to the PerformOffer owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:318:TryTranslateHasNothingToTradeMessage"] = "Popup sink handoff delegates capture restoration to the has-nothing owner-template helper.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:336:TryTranslateTradeUiPopupText"] = "Delegates capture restoration to branch-specific RestoreCapture helpers.",
            ["Mods/QudJP/Assemblies/src/Patches/TradeUiPopupTranslationPatch.cs:981:ShouldSkipMessagePatternTranslation"] = "Predicate only; it strips markup to classify already-localized visible popup text.",
