...
public sealed class ColorTagAllowlistCoverageTests
{
    ...
    private static readonly SortedDictionary<string, string> StripWithoutLocalRestoreAllowlist =
        new(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/CampfireNostrumsTranslationPatch.cs:160:TryTranslatePopupMessage"] = "Audited Strip call: generated target/condition captures are restored through the local MarkupAwareRestoreCapture helpers.",
