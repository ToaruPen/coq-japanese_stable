...
public sealed class CookingEffectFragmentTranslatorTests
{
    ...
    [TestCase("+3 to saves vs. disease", "病気に対するセーヴ+3")]
    [TestCase("Reflect 3-4% damage back at @their attackers, rounded up.", "@their 攻撃者にダメージの3-4%を切り上げて反射する。")]
    [TestCase("Reflect 3-4% damage back at your attackers, rounded up.", "攻撃者にダメージの3-4%を切り上げて反射する。")]
    ...
    [TestCase("Whenever you take damage, there's a 12-15% chance you teleport all creatures surrounding you.", "ダメージを受けるたび、12-15%の確率で周囲のすべての生物をテレポートさせる。")]
    ...
    [TestCase("Can use Burrowing Claws at level 5-6. If you already have Burrowing Claws, it's enhanced by 3-4 levels.", "〈掘爪〉をレベル5～6で使用できる。既に持つ場合、さらにレベル3～4強化される。")]
    ...
    [TestCase("Can use Psychometry at level 4-5.", "〈サイコメトリー〉をレベル4～5で使用できる。")]
    ...
    [TestCase("Can use Sticky Tongue at rank 4-5.", "〈粘着舌〉をランク4～5で使用できる。")]
    ...
    [TestCase("You thirst at half rate.", "喉の渇きが半減する。")]
    [TestCase("75% chance that itchy skin doesn't develop into a fungal infection.", "かゆみから真菌感染に進行しない確率が75%。")]
    [TestCase("?????", "？？？？？")]
