...
public sealed class DescriptionTextTranslatorTests
{
    ...
    [TestCase("You are water-bonded with him.", "あなたは相手と水の絆で結ばれている。")]
    [TestCase("You are water-bonded with her.", "あなたは相手と水の絆で結ばれている。")]
    [TestCase("You are water-bonded with it.", "あなたは相手と水の絆で結ばれている。")]
    [TestCase("You are water-bonded with them.", "あなたは相手と水の絆で結ばれている。")]
