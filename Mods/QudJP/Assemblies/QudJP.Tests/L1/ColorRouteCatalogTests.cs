...
internal static class ColorRouteCatalog
{
    ...
    internal static readonly SortedDictionary<string, int> ExpectedSymbolOccurrences =
        new SortedDictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNamePatch.cs|UITextSkinTranslationPatch.TranslatePreservingColors("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/GetDisplayNameProcessPatch.cs|UITextSkinTranslationPatch.TranslatePreservingColors("] = 1,
            ["Mods/QudJP/Assemblies/src/Patches/HistoricStringExpanderPatch.cs|UITextSkinTranslationPatch.TranslatePreservingColors("] = 1,
            ["Mods/QudJP/Assemblies/src/Patches/InventoryLocalizationPatch.cs|UITextSkinTranslationPatch.TranslatePreservingColors("] = 1,
