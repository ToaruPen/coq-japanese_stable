...
internal static class ColorRouteCatalog
{
    ...
    internal static readonly SortedDictionary<string, int> ExpectedSymbolOccurrences =
        new SortedDictionary<string, int>(StringComparer.Ordinal)
        {
            ...
            ["Mods/QudJP/Assemblies/src/Patches/DescriptionLongDescriptionPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/LookTooltipContentPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ["Mods/QudJP/Assemblies/src/Patches/PopupMessageTranslationPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ["Mods/QudJP/Assemblies/src/Patches/QudMenuBottomContextTranslationPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/UITextSkinTranslationPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ...
            ["Mods/QudJP/Assemblies/src/Patches/PopupShowTranslationPatch.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
            ["Mods/QudJP/Assemblies/src/Patches/SinkPrereqTextFieldTranslator.cs|ColorAwareTranslationComposer.TranslatePreservingColors("] = 1,
