...
public sealed class DecoyHologramDescriptionTranslationPatchTests
{
    ...
    [Test]
    public void TranslateHologramDescription_LeavesEmptyShortPropertyUnchanged()
    {
    ...
    [Test]
    public void TranslateHologramDescription_DoesNotThrowForNullDescriptionPart()
    {
        Assert.DoesNotThrow(() =>
            DecoyHologramDescriptionTranslationPatch.TranslateHologramDescriptionForTests(null));
    }
