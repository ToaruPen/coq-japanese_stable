...
public sealed class DynamicQuestConstructorConversationTextTranslatorTests
{
    ...
    [TestCase("I need someone to go to *deliveryTarget* and *verb* the *itemName* there", "*deliveryTarget*へ行き、そこの*itemName*を*verb*してくれる者が必要だ")]
    ...
    [TestCase("Would you be willing to recover *it* for us?", "われらのために*it*を取り戻してくれるか？")]
    [TestCase("Would you seek *it* out and return *it* to us?", "*it*を探し出し、われらのもとへ返してくれるか？")]
    [TestCase("We need someone to recover *it*, adventurer. Will you do it?", "*it*を取り戻してくれる者が必要だ、冒険者よ。引き受けてくれるか？")]
    ...
    [TestCase("Often we make pilgrimages to *verb* *it* and contemplate *sacredThing*", "われらはしばしば巡礼して*it*を*verb*し、*sacredThing*について思索する")]
    ...
    [TestCase("If you recover *it* for me, I'll reward your services", "*it*を取り戻してくれれば、あなたの奉仕には報いる")]
    [TestCase("Fetch *it* and I'll pay you for your assistance", "*it*を取り戻してくれれば、あなたの助力には代価を支払う")]
    [TestCase("I'm willing to compensate you for your work if you procure *it* for me", "*it*を取り戻してくれれば、あなたの働きには報酬を出す")]
