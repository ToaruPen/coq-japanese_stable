...
[HarmonyPatch]
public static class ElectromagneticImpulseTranslationPatch
{
    private const string Context = nameof(ElectromagneticImpulseTranslationPatch);
    ...
    private static IEnumerable<MethodBase> TargetMethods()
    {
        ...
        var targetType = AccessTools.TypeByName("XRL.World.Parts.Mutation.ElectromagneticImpulse");
    ...
    internal static bool TryTranslateQueuedMessage(ref string message, string? color)
    {
        ...
        if (!string.Equals(message, "{{r|You surge with energy!}}", StringComparison.Ordinal))
        {
            return false;
        }
