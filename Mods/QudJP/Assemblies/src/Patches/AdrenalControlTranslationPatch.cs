...
[HarmonyPatch]
public static class AdrenalControlTranslationPatch
{
    private const string Context = nameof(AdrenalControlTranslationPatch);
    ...
    private static IEnumerable<MethodBase> TargetMethods()
    {
        ...
        var targetType = AccessTools.TypeByName("XRL.World.Parts.Mutation.AdrenalControl2");
    ...
    internal static bool TryTranslateQueuedMessage(ref string message, string? color)
    {
        ...
        {
            "Your adrenaline subsides." => "アドレナリンが引いていく。",
            "{{G|Your adrenaline starts to flow.}}" => "{{G|アドレナリンが流れ始めた。}}",
            _ => null,
        };
