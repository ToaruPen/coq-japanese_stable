...
[HarmonyPatch]
public static class MonochromeOnsetTranslationPatch
{
    private const string Context = nameof(MonochromeOnsetTranslationPatch);
    ...
    internal static bool TryTranslateQueuedMessage(ref string message, string? color)
    {
        ...
        var translated = message switch
        {
            ...
            "Your vision blurs." => "視界がぼやける。",
            "Your vision clears up." => "視界が晴れた。",
            _ => null,
        };
