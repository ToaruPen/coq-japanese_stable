...
public static class JournalLineTranslationPatch
{
    ...
    {
        return FrameworkDataElementSetDataTargetResolver.Resolve(Context, "Qud.UI.JournalLine", "JournalLine");
    }
    ...
    {
        if (GetIntMemberValue(screen, "CurrentCategory") == 2)
        {
            return false;
        }
        ...
        return string.Equals(sizeClassValue?.ToString(), "Small", StringComparison.Ordinal);
    }
