...
[HarmonyPatch]
public static class BrittleBonesTranslationPatch
{
    private const string Context = nameof(BrittleBonesTranslationPatch);
    ...
    private static IEnumerable<MethodBase> TargetMethods()
    {
        ...
        var targetType = AccessTools.TypeByName("XRL.World.Parts.Mutation.BrittleBones");
    ...
    internal static bool TryTranslateQueuedMessage(ref string message, string? color)
    {
        ...
        if (!string.Equals(message, "You feel your bones fracture.", StringComparison.Ordinal))
        {
            return false;
        }

        const string translated = "骨がひび割れるのを感じた。";
