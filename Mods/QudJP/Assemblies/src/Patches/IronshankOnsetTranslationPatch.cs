...
[HarmonyPatch]
public static class IronshankOnsetTranslationPatch
{
    private const string Context = nameof(IronshankOnsetTranslationPatch);
    ...
    private static IEnumerable<MethodBase> TargetMethods()
    {
        ...
        var targetType = AccessTools.TypeByName("XRL.World.Effects.IronshankOnset");
    ...
    internal static bool TryTranslateQueuedMessage(ref string message, string? color)
    {
        ...
        var translated = message switch
        {
            ...
            "Your legs ache at the joints." => "脚の関節が痛む。",
