...
[HarmonyPatch]
public static class StairsDownTranslationPatch
{
    private const string Context = nameof(StairsDownTranslationPatch);
    ...
    {
        var targetType = AccessTools.TypeByName("XRL.World.Parts.StairsDown");
    ...
    internal static bool TryTranslatePopupMessage(string source, string route, string family, out string translated)
    {
        ...
        return StairsDownFragmentTranslator.TryTranslatePopupMessage(source, route, family + "." + Context, out translated);
    }
}
