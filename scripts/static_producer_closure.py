...
COVERED_OWNER_FAMILIES: Final = (
    ...
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(GameObjectStatPopupTranslationPatch)", "System.Int32|System.Boolean"),
            ),
        ),
    ),
    CoveredOwnerFamily(
    ...
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(RepairTranslationPatch)", "XRL.World.InventoryActionEvent"),
            ),
        ),
    ),
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(RepairTranslationPatch)", "XRL.World.GameObject|XRL.World.GameObject"),
            ),
        ),
    ),
    CoveredOwnerFamily(
    ...
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(PlayerDanceRitualTranslationPatch)", "System.String|System.String"),
            ),
        ),
    ),
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(PlayerDanceRitualTranslationPatch)", "System.String"),
            ),
        ),
    ),
    CoveredOwnerFamily(
    ...
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(BeguilingSifrahTranslationPatch)", "XRL.World.GameObject"),
            ),
        ),
    ),
    CoveredOwnerFamily(
    ...
    CoveredOwnerFamily(
        ...
        evidence_files=(
            ...
            EvidenceFile(
                "Mods/QudJP/Assemblies/QudJP.Tests/L2G/TargetMethodResolutionTests.cs",
                ("typeof(ProselytizationSifrahTranslationPatch)", "XRL.World.GameObject"),
            ),
        ),
    ),
    CoveredOwnerFamily(
