...
- steamcmd command (local path redacted): `steamcmd +login "$STEAM_USER" +workshop_build_item "<absolute-workspace-path>/dist/workshop/workshop_item.vdf" +quit`
- Upload completed at: around `2026-06-11 07:11 +0900`
- Steam output summary: cached login for `<redacted>` succeeded; content, preview image, and update commit completed with `Committing update...Success.`
